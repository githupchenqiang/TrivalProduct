...
#import "FMDBSource.h"
#import "UIView+HUD.h"
@interface NearByDetailViewController ()<UIScrollViewDelegate,UIWebViewDelegate>
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        [self.navigationItem setRightBarButtonItems:[NSArray arrayWithObjects: self.buttonItem,self.CollecbuttonItem,nil]];
